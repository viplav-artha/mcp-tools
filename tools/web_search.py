...
async def web_search(query: str, provider: Literal["duckduckgo", "tavily"] = "duckduckgo") -> str:
    ...
    snippets. Prefer provider='duckduckgo' (free) by default to save cost.
    Only use provider='tavily' (paid, higher-quality AI-optimized results)
